...
export function SubjectGoals({ subjectId, goals, notes, topics = [], metricDefinitions, onCreateTopic, onCreate, onRemove, onComplete, onSetSubGoalCompletion }) {
