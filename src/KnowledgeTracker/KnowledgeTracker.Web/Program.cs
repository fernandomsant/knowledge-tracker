...
builder.Services.AddScoped<IClassificationUpdateRepository, SqlServerClassificationUpdateRepository>();
...
builder.Services.AddScoped<IClassificationUpdateService, ClassificationUpdateService>();
