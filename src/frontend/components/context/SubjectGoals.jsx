...
export function SubjectGoals({ subjectId, goals, notes, topics = [], metricDefinitions, onCreateTopic, onRemoveTopic, onCreate, onRemove, onComplete, onSetSubGoalCompletion }) {
