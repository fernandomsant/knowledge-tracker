...
public interface ISubjectGoalService
{
    ...
    Task<SubjectGoalDayRecordDetails?> RecordDayAsync(Guid id, DateOnly occurredOn, bool isCompleted, CancellationToken ct);
    Task<bool> DeleteAsync(Guid id, CancellationToken ct);
    Task<SubjectGoalDayRecordDetails?> CompleteAsync(Guid id, CancellationToken ct);
