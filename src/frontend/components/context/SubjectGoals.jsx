...
export function SubjectGoals({ goals, notes, topics = [], metricDefinitions, onCreateTopic, onCreate, onRemove, onComplete, onSetSubGoalCompletion }) {
