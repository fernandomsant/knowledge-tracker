...
public sealed class SqlServerSubjectGoalCompletionRepository(Func<DbConnection> connectionFactory, CurrentUserDataScope dataScope) : ISubjectGoalCompletionRepository
{
